...
################################################################
# This is a generated script based on design: ps_block
#
...
proc create_root_design { parentCell } {
  ...
  set axi_ddr [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 axi_ddr ]
  ...
  set ps_rvram [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 ps_rvram ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {axi_ddr} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__ACT_FREQMHZ {24.561404} \
   CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__DIVISOR0 {19} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {233.333338} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {6} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {233.4} \
  ...
  connect_bd_intf_net -intf_net axi_ddr_1 [get_bd_intf_ports axi_ddr] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net bram_ctrl_BRAM_PORTA [get_bd_intf_ports ps_rvram] [get_bd_intf_pins bram_ctrl/BRAM_PORTA]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins bram_ctrl/S_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins bram_ctrl/s_axi_aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports clk_100m] [get_bd_pins bram_ctrl/s_axi_aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_ports rst_n] [get_bd_pins rst_ps8_0_100M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs bram_ctrl/S_AXI/Mem0] SEG_bram_ctrl_Mem0
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_ddr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_ddr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
